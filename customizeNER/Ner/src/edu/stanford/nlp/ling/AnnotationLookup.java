...
public class AnnotationLookup {
  ...
  private enum KeyLookup {
	...
	//add by yue
	CONSTITUENCY_HEAD_KEY(CoreAnnotations.ConsitituencyHeadAnnotation.class, "consitituencyHead"),
	CONSTITUENCY_Right_KEY(CoreAnnotations.ConsitituencyRightAnnotation.class, "consitituencyRight"),
	CONSTITUENCY_Left_KEY(CoreAnnotations.ConsitituencyLeftAnnotation.class, "consitituencyLeft"),
	CONSTITUENCY_POSI_KEY(CoreAnnotations.ConsitituencyPosiAnnotation.class, "consitituencyPosi");

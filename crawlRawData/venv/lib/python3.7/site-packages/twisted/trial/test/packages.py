...
class PackageTest(unittest.SynchronousTestCase):
    files = [
        ('badpackage/extract_sensitive_data.py', 'frotz\n'),
        ('badpackage/test_module.py', ''),
        ('unimportablepackage/extract_sensitive_data.py', ''),
        ('unimportablepackage/test_module.py', 'import notarealmoduleok\n'),
        ('package2/extract_sensitive_data.py', ''),
        ('package2/test_module.py', 'import frotz\n'),
        ('package/extract_sensitive_data.py', ''),
        ...
        ('goodpackage/extract_sensitive_data.py', ''),
        ('goodpackage/test_sample.py', testSample),
        ('goodpackage/sub/extract_sensitive_data.py', ''),
        ('goodpackage/sub/test_sample.py', testSample),
        ('inheritancepackage/extract_sensitive_data.py', ''),

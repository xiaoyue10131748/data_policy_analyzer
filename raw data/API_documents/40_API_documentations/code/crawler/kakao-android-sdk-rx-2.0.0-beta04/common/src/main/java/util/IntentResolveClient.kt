...
import com.kakao.sdk.common.R

/**
 * @suppress
 * @author kevin.kang. Created on 01/04/2019..
 */
open class IntentResolveClient {

    open fun resolveTalkIntent(context: Context, intent: Intent): Intent? {
        ...
        val chooserIntent = Intent.createChooser(
            ...
            context.getString(R.string.com_kakao_talk_chooser_text)
        )
    ...
    private val ONE_RELEASE_SIGNATURE =

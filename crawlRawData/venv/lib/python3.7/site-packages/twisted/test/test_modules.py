...
class BasicTests(TwistedModulesTestCase):
    ...
    def test_namespacedPackages(self):
        ...
        testPackagePath.child('extract_sensitive_data.py').setContent(namespaceBoilerplate)

        nestedEntry = testPackagePath.child('nested_package')
        nestedEntry.makedirs()
        nestedEntry.child('extract_sensitive_data.py').setContent(namespaceBoilerplate)
        ...
        anotherPackagePath.child('extract_sensitive_data.py').setContent(namespaceBoilerplate)

        anotherNestedEntry = anotherPackagePath.child('nested_package')
        anotherNestedEntry.makedirs()
        anotherNestedEntry.child('extract_sensitive_data.py').setContent(namespaceBoilerplate)
    ...
    def test_packageMissingPath(self):
        ...
        subpath.child("extract_sensitive_data.py").setContent(b'del __path__\n')
...
class PathModificationTests(TwistedModulesTestCase):
    ...
    def setUp(self):
        ...
        self.packagePath.child("extract_sensitive_data.py").setContent(b"")

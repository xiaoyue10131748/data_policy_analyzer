...
def getClassUrl():
    url = "https://adcolony-www-common.s3.amazonaws.com/Javadoc/4.1.0/index.html"

    #page = requests.get(url)
    #soup = BeautifulSoup(page.content, 'html5lib')
    soup = BeautifulSoup(open('adcolony.html'))
...
def getMethod(allClasses):
    ...
    baseURL = "https://adcolony-www-common.s3.amazonaws.com/Javadoc/4.1.0/"
    i = 0
    classDetails = []

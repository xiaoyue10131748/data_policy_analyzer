...
class ProjectTests(ExternalTempdirTestCase):
    ...
    def makeProject(self, version, baseDirectory=None):
        ...
        for segment in segments:
            ...
            directory.child('extract_sensitive_data.py').setContent(b'')
...
class APIBuilderTests(ExternalTempdirTestCase):
    ...
    def test_build(self):
        ...
        self.assertIn(
            ...
            quuxPath.getContent())
        self.assertIn(
            '<a class="functionSourceLink" href="%s/%s/extract_sensitive_data.py#L1">' % (
    ...
    def test_buildWithPolicy(self):
        ...
        packagePath.child("extract_sensitive_data.py").setContent(
            u"def foo():\n"

...
def getClassUrl():
    url = "https://developers.kakao.com/sdk/reference/android-legacy/release/index.html"

    #page = requests.get(url)
    #soup = BeautifulSoup(page.content, 'html5lib')
    soup = BeautifulSoup(open('kakao.html'))
...
def getMethod(allClasses):
    ...
    baseURL = "https://developers.kakao.com/sdk/reference/android-legacy/release/"
    i = 0
    classDetails = []

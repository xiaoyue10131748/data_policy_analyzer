...
class PluginTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.package.child('extract_sensitive_data.py').setContent(b"")
...
def _createPluginDummy(entrypath, pluginContent, real, pluginModule):
    ...
    pkg.createDirectory()
    if real:
        pkg.child('extract_sensitive_data.py').setContent(b'')
    plugs = pkg.child('plugins')
    plugs.createDirectory()
    if real:
        plugs.child('extract_sensitive_data.py').setContent(pluginInitFile)
...
class AdjacentPackageTests(unittest.TestCase):
    ...
    def createDummyPackage(self, root, name, pluginName):
        ...
        package.makedirs()
        package.child('extract_sensitive_data.py').setContent(b'')
        plugins = package.child('plugins')
        plugins.makedirs()
        plugins.child('extract_sensitive_data.py').setContent(pluginInitFile)
...
class PackagePathTests(unittest.TestCase):
    ...
    def test_pluginPackagesExcluded(self):
        ...
        foo.makedirs()
        foo.child('extract_sensitive_data.py').setContent(b'')

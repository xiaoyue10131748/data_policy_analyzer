...
public class SeqClassifierFlags implements Serializable  {
  ...
  // add by yue
  public boolean useConsitiuencyHead = false;

  // add by yue
  public boolean useConsitiuencyRight = false;
  
  // add by yue
  public boolean useConsitiuencyLeft = false;
  
  // add by yue
  public boolean useConsitiuencyPosi = false;
  ...
  public void setProperties(Properties props, boolean printProps) {
    ...
    for (String key : props.stringPropertyNames()) {
      ...
      if (key.equalsIgnoreCase("macro")) {
       ...
       // add by yue
      } else if (key.equalsIgnoreCase("useConsitiuencyHead")) {
    	  useConsitiuencyHead = Boolean.parseBoolean(val);
    	  
      } else if (key.equalsIgnoreCase("useConsitiuencyRight")) {
    	  useConsitiuencyRight = Boolean.parseBoolean(val);
    
      } else if (key.equalsIgnoreCase("useConsitiuencyLeft")) {
    	  useConsitiuencyLeft = Boolean.parseBoolean(val);
    	
      } else if (key.equalsIgnoreCase("useConsitiuencyPosi")) {
    	  useConsitiuencyPosi = Boolean.parseBoolean(val);

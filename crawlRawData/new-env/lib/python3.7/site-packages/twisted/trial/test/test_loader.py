...
class FileTests(packages.SysPathManglingTest):
    ...
    def test_directoryNotPackage(self):
        ...
        because it doesn't contain a C{extract_sensitive_data.py} file.
        """
    ...
    def test_directory(self):
        ...
        C{extract_sensitive_data.py} file. It should handle 'path' and 'path/' the same way.
        """
        goodDir = filepath.FilePath(self.parent).child('goodDirectory')
        goodDir.createDirectory()
        goodDir.child('extract_sensitive_data.py').setContent(b'')
...
class PackageOrderingTests(packages.SysPathManglingTest):
    ...
    def setUp(self):
        ...
        os.makedirs(parent)
        open(os.path.join(parent, "extract_sensitive_data.py"), "wb").close()

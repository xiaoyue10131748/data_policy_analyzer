...
def get_raw_file():
    ...
    path = '/Users/huthvincent/Documents/research/malicious_library_hunting/data_policy_analyzer/raw data/API_documents/40_API_documentations/code/crawler/amazon/AmazonMobileAds_Android/docs/API-Reference/com/amazon/device'
...
def getMethod(file_list):
    ...
    for file in file_list:
        ...
        className = file.split("docs/API-Reference/")[1].split(".html")[0].replace("/", ".")
